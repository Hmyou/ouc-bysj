...
class OneSports2 extends React.Component {
  state = {
    loading:false,
    lineData:[]
  };
  ...
  Line = createG2(chart => {
    ...
    chart.line().position('time*total_time').color('#5ed470').size(2).shape('smooth').tooltip('total_time*device_num'); // 绘制曲线图
...
const OneSports2Form = Form.create()(OneSports2);
export default OneSports2Form;
