...
class CompareS3Form extends React.Component{
  state = {
    lineData: [
  ...
  Line = createG2(chart => {
    ...
    chart.col('value', {
      alias: this.state.YItem=="1"?'人均个数':'人均训练总时间（分钟）'
    });
    chart.render();
  });
...
const CompareS3 = Form.create()(CompareS3Form);
export default CompareS3;
